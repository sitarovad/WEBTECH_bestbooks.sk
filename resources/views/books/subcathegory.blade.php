...
@section('content')
    <h1 id="cathegory-title">{{$cathegory->name}}: {{$subcathegory->name}}</h1>
    <hr>
    <div class="container">
        <div class="row">
            <div class="col-md-3" id="filter-menu">
                <section>
                    ...
                    <ul class="list-unstyled">
                        @foreach($subcathegories as $subcatheg)
                            <li>
                                <a href="/subcathegory/{{$subcatheg->id}}">{{$subcatheg->name}}</a>
                            </li>
                        @endforeach
                    </ul>
                </section>
                ...
                <section>
                    <h2>Filter</h2>
                    <form method="GET" action="/subcathegory/{{$subcathegory->id}}/filtred">
